...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name = '/home/jianing/Github/LLMRL/checkpoints/tinyllama-critic-MetaMath', # "unsloth/tinyllama" for 16bit loading
...
trainer = Trainer(
    ...
    args = TrainingArguments(
        ...
        seed = 3407,
        output_dir = "checkpoints/tinyllama-critic-MetaMath-2",
        report_to= "wandb",
    ),
)
...
model.save_pretrained("checkpoints/tinyllama-critic-MetaMath-2") # Local saving
tokenizer.save_pretrained("checkpoints/tinyllama-critic-MetaMath-2") # Local saving
